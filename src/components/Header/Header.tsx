...
const NavButton = ({ onClick }) => {
  return (
    <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg" className='fill-carrot dark:fill-dodger absolute top-4 right-4' onClick={onClick}>
...
const SideNav = ({ isOpen, setIsOpen }) => {
  ...
  return (
    <div className={`w-full h-screen grid grid-cols-[1fr_3fr] absolute transition-all z-10 ${isOpen ? 'left-0 right-auto' : 'right-full left-auto'}`
    }>
